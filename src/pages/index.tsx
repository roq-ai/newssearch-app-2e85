  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the power of truth with Newssearch app - your trusted partner in navigating through news stories with credible fact-checks, customizable filters, and educational resources. Empower your understanding, because knowledge is power."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the power of truth with Newssearch app - your trusted partner in navigating through news stories with credible fact-checks, customizable filters, and educational resources. Empower your understanding, because knowledge is power.`}
            </Text>
            <Box
